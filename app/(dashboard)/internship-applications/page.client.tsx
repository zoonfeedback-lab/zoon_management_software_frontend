...
export default function InternshipApplicationsClient() {
  ...
  return (
    <div className="grid gap-6 animate-in fade-in zoom-in-95 duration-500">
      ...
      {isResilientMode && (
        <div className="bg-[#ff2026]/10 border border-[#ff2026]/30 px-5 py-3 rounded-md flex items-center justify-between mb-4">
          ...
          <span className="text-[9px] font-bold text-zinc-400 uppercase tracking-widest hidden md:inline-block">Live link severed. Displaying tactical mock databanks.</span>
        </div>
      )}
